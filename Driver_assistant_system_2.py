...
def compute_remaining_time_min(remaining_distance_km, route_average_speed_kph):
    if route_average_speed_kph is None or route_average_speed_kph <= 0:
        return None
    return (remaining_distance_km / route_average_speed_kph) * 60.0
...
speed_card, speed_box = make_status_card(status_frame, "SPEED LIMIT", wraplength=180, value_font=("Arial", 20, "bold"))
speed_card.grid(row=0, column=0, sticky="nsew", padx=8, pady=6)

advisory_card, advisory_box = make_status_card(status_frame, "ADVISORY", wraplength=180, value_font=("Arial", 20, "bold"))
...
control_card, control_box = make_status_card(status_frame, "CONTROL", wraplength=360, value_font=("Arial", 17, "bold"))
...
for segment in edge_attributes:
    ...
    remaining_time_min = compute_remaining_time_min(remaining_distance_km, route_average_speed_kph)
